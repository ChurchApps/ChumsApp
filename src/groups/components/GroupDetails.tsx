...
import { type GroupInterface, Loading, Locale, MarkdownPreview, ImageEditor } from "@churchapps/apphelper";
...
export const GroupDetails = memo((props: Props) => {
  ...
  const labelChips = useMemo(() => 
    group?.labelArray?.map((label, index) => (
      <Chip
                  ...
                  <Box>
                    ...
                    <Grid container spacing={2}>
                      <Grid size={{ xs: 12, sm: 4 }}>
                        ...
                        <Typography variant="body1">
                          {booleanDisplays.trackAttendance}
                        </Typography>
                      </Grid>
                      <Grid size={{ xs: 12, sm: 4 }}>
                        <Typography variant="body2" color="text.secondary">
