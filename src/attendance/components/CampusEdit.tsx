  ...
  return (
    ...
    >
      {({
        ...
        <InputBox id="campusBox" data-cy="campus-box" cancelFunction={props.updatedFunction} saveFunction={handleSubmit} deleteFunction={handleDelete} headerText={campus.name} headerIcon="fas fa-church" isSubmitting={isSubmitting}>
          <Form.Group>
