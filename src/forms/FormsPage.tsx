...
export const FormsPage = () => {
  ...
  const getRows = () => {
    ...
    if (!forms.length) {
      result.push(<tr key="0"><td>No custom forms have been created yet. They will appear here when added. --- ADMIN: {UserHelper.checkAccess(Permissions.membershipApi.forms.admin) } EDIT: { UserHelper.checkAccess(Permissions.membershipApi.forms.edit) }</td></tr>);
      return result;
    }
