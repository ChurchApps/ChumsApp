...
export const SettingsPage = () => {
  ...
  const getLinks = () => {
    ...
    if (UserHelper.checkAccess(Permissions.accessApi.settings.edit)) result.push(<BigLinkButton key="managePermissions" outsideLink={true} href={UserHelper.goToAccountsApp(returnUrl)} icon="fas fa-lock" text="Manage Permissions" />);
