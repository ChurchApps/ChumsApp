...
import { ApiHelper, DateHelper, DisplayBox, InputBox, LinkInterface, Locale } from "@churchapps/apphelper";
import { type ArrangementInterface, type ArrangementKeyInterface } from "../../../helpers";
...
export const LinkEdit = (props: Props) => {
  ...
  return (<InputBox headerText={Locale.label("songs.link.edit")} headerIcon="link" saveFunction={handleSave} cancelFunction={props.onCancel} deleteFunction={(link?.id) ? handleDelete : null}>
