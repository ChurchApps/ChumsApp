...
export interface ReportResultInterface { displayName: string, description: string, tables: { keyName: string, data: any[] }[], outputs: ReportOutputInterface[] }
...
export interface ReportOutputInterface { outputType: string, columns: ColumnInterface[] }
