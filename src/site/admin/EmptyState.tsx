...
export function EmptyState() {
  return (
    <Container key="empty">
      <Box sx={{
        display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '400px', textAlign: 'center', py: 6, px: 3 
      }}>
        <Box sx={{
          width: 80, height: 80, borderRadius: '50%', backgroundColor: '#f5f5f5', display: 'flex', alignItems: 'center', justifyContent: 'center', mb: 3 
        }}>
        ...
        <Box sx={{
          display: 'flex', alignItems: 'center', gap: 1, px: 3, py: 1.5, backgroundColor: '#f8f9fa', borderRadius: 1, border: '1px dashed #e0e0e0' 
        }}>
